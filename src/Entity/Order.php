...
class Order
{
    ...
    /**
     * @ORM\OneToMany(targetEntity=Payment::class, mappedBy="product_order", orphanRemoval=true)
     */
    private $payment;
    ...
    public function removePayment(Payment $payment): self
    {
        if ($this->payment->removeElement($payment)) {
            ...
            if ($payment->getProductOrder() === $this) {
                $payment->setProductOrder(null);
            }
        }
